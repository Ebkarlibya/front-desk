frappe.require(["point-of-sale.bundle.js"], function () {
  inn.PointOfSale.PosExtendPastOrderSummary = class PosExtendPastOrderSummary extends (
      ...
      return [
        {
          ...
          visible_btns: ["Show Bill", "Edit Order", "Delete Order"],
        },
        {
    ...
    print_receipt() {
      ...
      console.log("Printing receipt for", frm);
      frappe.utils.print(
        this.doc.doctype,
        this.doc.name,
    ...
    get_upper_section_html(doc) {
      ...
      return `<div class="left-section">
                    ...
                    <div class="table-number">${__(
                      "Table"
                    )}: ${table_number}</div>
                    <div class="cashier">${__("Sold by")}: ${doc.owner}</div>
                </div>
                <div class="right-section">
                    <div class="paid-amount">${format_currency(
                      doc.paid_amount,
                      doc.currency
                    )}</div>
