frappe.query_reports["Reservation Guest List"] = {
  ...
  formatter: function (value, row, column, data, default_formatter) {
    ...
    if (column.fieldname === "room") {
      ...
      value =
        `<i class="fa fa-calendar" style="margin-right:5px;"></i>` + value;
      ...
      value =
        `<i class="fa fa-circle" style="margin-right:5px; color:#5bc0de;"></i>` +
        value;
      ...
      value =
        `<i class="fa fa-sign-out" style="margin-right:5px;"></i>` + value;
    }
